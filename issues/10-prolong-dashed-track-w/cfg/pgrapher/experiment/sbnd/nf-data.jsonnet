...
function(params, anode, chndbobj, n, name='', dft=default_dft)
  {
    local single = {
      ...
      data: {
        ...
        // positive on a long ionisation pulse: the branch skips the RC-RC
        // deconvolution and applies RawAdapativeBaselineAlg's 20-tick sliding
        // baseline, deleting most of the signal.  Disabling keeps the RC-RC
        // deconvolution -- which IS needed -- on every channel.  Same change as
        // nf.jsonnet (the sim path); see ai-helper issue #10.
